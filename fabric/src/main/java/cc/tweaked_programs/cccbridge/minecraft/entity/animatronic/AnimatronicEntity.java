package cc.tweaked_programs.cccbridge.minecraft.entity.animatronic;

import cc.tweaked_programs.cccbridge.assistance.misc.RustyMovement;
...
public class AnimatronicEntity extends Entity {
    ...
    private Rotations updatePose(Rotations start, Rotations destination) {
        float x = RustyMovement.updateMovement(start.getX(), destination.getX(), step);
        float y = RustyMovement.updateMovement(start.getY(), destination.getY(), step);
        float z = RustyMovement.updateMovement(start.getZ(), destination.getZ(), step);
